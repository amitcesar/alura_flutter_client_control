...
class _ClientsPageState extends State<ClientsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<Clients>(builder: (BuildContext context, Clients list, _) {
  ...
  void createType(context) {
    ...
    Types listTypes = Provider.of(context, listen: false);
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            actions: [
              Consumer<Clients>(
                  builder: (BuildContext context, Clients list, _) {
                return TextButton(
